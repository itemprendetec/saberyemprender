...
const Private = ({ data }) => {
  ...
  return (
    <>
      <Head>
        <title>Panel de Gestión de Participantes - IUTCM: Saber y Emprender</title>
      </Head>
      <div>
        {loading ? <>
          Loading..
                              ...
                              <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                ...
                                <td class="flex items-center p-4 mr-12 space-x-6 whitespace-nowrap">
                                  <div class="text-sm font-normal text-gray-500 dark:text-gray-400">
                                    <div class="text-base font-semibold text-gray-900 dark:text-white">{String(usr.NOMBRE_APELLIDO).toUpperCase()}</div>
                                  </div>
                                </td>

                                <td class="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white">V-{usr.CEDULA}</td>
                                <td class="max-w-sm p-4 overflow-hidden text-base font-npositional text-gray-500 truncate xl:max-w-xs dark:text-gray-400">{usr.CORREO}</td>
                                <td class="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white">{usr.TELEFONO}</td>
                                <td class="p-4 text-xs uppercase font-medium text-gray-900 whitespace-nowrap dark:text-white text-center">
                                  <span className='font-bold block'> {usr.SECCION}</span>
                                </td>
                                <td class="p-4 text-xs uppercase font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                  <span className='font-bold block'>{usr.HORARIO.turno == 0 ? "Turno matutino" : "Turno vespertino"}</span>
                                </td>
                                <td class="p-4 text-xs uppercase font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                  <span className='font-bold block'>{usr.HORARIO.dias == 0 ? "Lunes y Martes" : "Miercoles y Jueves"}</span>
                                </td>
